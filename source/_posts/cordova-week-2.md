...
![](images/cordova-week-2/create-azure-hub-step-1.png)

輸入 Notification Hub 相關資料，完成後點擊建立按鈕：

![](images/cordova-week-2/create-azure-hub-step-2.png)

回到儀表板，可以看到剛建立好的通知中樞：

![](images/cordova-week-2/azure-dash-board.png)

點擊通知中樞可以看到詳細資訊：

![NOTIFICATION SETTINGS 則是通知中樞所支援的平台](images/cordova-week-2/create-azure-hub-step-3.png)
...
![](images/cordova-week-2/create-fcm-project-step-1.png)

然後輸入專案相關資訊：專案名稱、ID 及國家或地區，並點擊建立專案。

![](images/cordova-week-2/create-fcm-project-step-2.png)

專案建立完成後，會進到專案的 dash board，點選左上角的齒輪展開選單，點擊`專案設定`：

![](images/cordova-week-2/create-fcm-project-step-3.png)

點選後會看到專案的相關資訊，捲軸滾到下方可以看到目前專案中沒有任何應用程式，點擊中間將 Firebase 加入您的 Android 應用程式的選項：

![](images/cordova-week-2/fcm-create-android-app.png)

點擊後進入新增 Android 應用程式的畫面，輸入 App 相關資訊，輸入完成後點擊註冊應用程式：

![](images/cordova-week-2/fcm-create-android-app-2.png)

註冊完成之後，點選 下載 google-services.json` 按鈕進行下載，並將檔案存放在 Cordova 專案的根目錄。

![](images/cordova-week-2/fcm-create-android-app-3.png)
...
![](images/cordova-week-2/create-fcm-project-step-4.png)

會看到專案憑證的資訊及寄件者 ID，而伺服器金鑰則是建立 Azure Notification Hub 之後要設定的 API Key：

![](images/cordova-week-2/create-fcm-project-step-5.png)

進入 Googel ( GCM ) 的設定，並將複製的 API Key 貼上：

![](images/cordova-week-2/android-add-api-key.png)
...
![](images/cordova-week-2/android-send-test.png)
